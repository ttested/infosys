...
function RunEngine()
{
	...
	$grid['heder']='Должности';
	$grid['title']='Должности';
	$grid['control']='<button type="button" class="btn btn-primary" data-toggle="modal_prof" data-target="#dict_appointments" onclick="EditAppointment(0);">Новая профессия</button>';	
