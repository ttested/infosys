...
function RunEngine()
{
	...
	$grid['heder']='Платежные системы';
	$grid['title']='Платежные системы';
	$grid['control']='<button type="button" class="btn btn-primary" data-toggle="modal_'.$table.'" data-target="#dict_prava" onclick="EditPlatsys(0);">Новая категоря</button>';	
