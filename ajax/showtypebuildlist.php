...
function RunEngine()
{
	...
	$grid['heder']='Типы объектов';
	$grid['title']='Типы объектов строительства';
	$grid['control']='<button type="button" class="btn btn-primary" data-toggle="modal_'.$table.'" data-target="#dict_prava" onclick="EditTypebuild(0);">Новая категоря</button>';	
