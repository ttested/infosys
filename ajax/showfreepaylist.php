...
function RunEngine()
{
	...
	//Служебные данные
	$grid['tabid']=$table;
	$grid['heder']='Выданные средства';
	$grid['title']='';
	$grid['control']='<button type="button" class="btn btn-primary" data-toggle="modal_'.$table.'" data-target="#'.$table.'" onclick="EditGetPay(0,\'\',\'\',\'\',1);">Выдать средства</button>';	
